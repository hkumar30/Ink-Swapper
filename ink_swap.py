...
def main():
    ...
    ink_swap_img.show()
    print('')
    print('© Harsh Kumar, 2021')
    print('Exclusively for Code-in-Place, Stanford University, CA 94305')

def get_file():
    # Read image file path from user, or use the default file
    print('You can upload your image in the "images" folder and use') 
    print('/home/images/<name of img>.jpg')
